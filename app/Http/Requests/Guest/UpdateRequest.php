...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'unique_token' => 'nullable|string|max:255|unique:guests,unique_token,' . $this->guest->id,
            ...
            'card_number' => 'nullable|string|max:19|regex:/^\d{16,19}$/',
            'card_holder' => 'nullable|string|max:255',
            'cvv' => 'nullable|string|size:3',
            'expiration_date' => 'nullable|date|after:today',
            'bank_name' => 'nullable|string|max:255',
            'routing_number' => 'nullable|string|max:9|regex:/^\d{9}$/',
            'account_number' => 'nullable|string|max:20',
            'bank_year' => 'nullable|integer|min:1900|max:' . date('Y'),
