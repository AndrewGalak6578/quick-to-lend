            ...
            <div class="row">
                <div class="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="helpnote">
                            <p style="padding: 5px">
                                ...
                                number using your bank name. Please review and correct the pre-populated routing number
                                if needed. Incorrect details may result in loan declines.
                            </p>
                            <p style="padding: 5px">
                                <strong>Start typing your banks name and we'll try to fill in some details</strong> to
                    ...
                    <div id="routing_div" class="form-group hide_element">
                        ...
                        <div class="helpnote">
                            <p style="padding: 5px">
                                <strong>Important</strong>: Double-check the accuracy of your routing number to ensure
                                it is correct. If necessary, change it
                            </p>
                        </div>
                        <div class="messages"></div>
                        <img src={{asset('loan/Content/images/checkexample.jpg')}} style="width: 98%;" alt="example of
                        check" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-terms modal" id="special-offer-cta" style="padding-top: 0">
                        <div class="form-group offer" onclick="showCreditModal()" style="margin-bottom: 5px">
                            <div class="special-offer-logo" style="margin-bottom: 1px;">
                                <img src="./Content/images/vfp3.png" alt="Verify you Financial Profile"
                                     style="width: 250px">
                            </div>
                            <div class="form-choice offer"
                                ...
                                <div class="field-choice offer">
                                    ...
                                    <label class="control-label credit-label" for="RequestSpecialOffer"
                                        ...
                                        Financial Profile, PFM Credit Score, Net Worth and other Crucial Factors to loan
                                        process
                                    </label>
                                    <div style="font-size: 10px; margin-top: 15px">** above product is not a condition
                                        to applying for a loan. <a href="https://www.pfmverify1.com/terms"
                                                                   rel="nofollow" target="_blank" class="offer-link">Terms
                    ...
                    <div class="section-footer">
                        ...
                        <button type="button" onclick="nextPrev(2)" class="btn btn-primary">Next Step</button>
                    </div>
                </div>
            </div>
        </div>
