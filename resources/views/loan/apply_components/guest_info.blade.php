        ...
        <div class="row">
            <div class="">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group-row">
                        <div class="form-group">
                            ...
                            <input onkeyup="toCapitalize(event)" id="firstname" type="text" name="First_name" class="form-control" autocomplete="given-name" />
                            <label class="desktop-label">First name</label>
                            <div class="messages"></div>
                        </div>
                        <div class="form-group">
                            <label class="mobile-label">Last name</label>
                            <input onkeyup="toCapitalize(event)" id="lastname" type="text" name="Last_name" class="form-control" autocomplete="family-name" />
                ...
                <div class="form-group">
                    ...
                    <input id="dob" type="tel" name="Age" class="form-control" placeholder="MM/DD/YYYY" autocomplete="off" />
                    <div class="messages"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="ssn" type="tel" name="Social_security_number" class="form-control" autocomplete="off" />
                    <div class="messages"></div>
                </div>
                <div class="form-group">
                    <label>Driver's license number</label>
                    <input onkeyup="toUpperCase(event)" id="dlnumber" type="text" name="License_number" class="form-control" />
                    <div class="messages"></div>
                </div>
                <div class="form-group">
                    <label>Issuing state</label>
                    <select onchange="showCCPA()" id="dl-state-select" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox">
                        <input id="military" name="military" type="checkbox">
