        ...
        <div class="row">
            <div class="">
                ...
                <div class="form-group">
                    ...
                    <input onkeyup="toUpperCase(event)" id="housestreet" type="text" name="Street_address" class="form-control" />
                    <div class="messages"></div>
                </div>
                <div class="form-group">
                    <label>City</label>
                    <input id="city" type="text" name="City_or_town" class="form-control" />
                    <div class="messages"></div>
                </div>
                <div class="form-group">
                    <label>County</label>
                ...
                <div class="form-group">
                    <label>State</label>
                    <select onchange="showCCPA()" id="state-select" class="form-control">
