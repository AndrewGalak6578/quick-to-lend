...
{{--3--}}
@section('content')
<div class="section section-income" id="form_income">
    <div class="container">
        <div class="row">
            <div class="">
                ...
                <div class="form-group">
                    ...
                    <div class="form-choice mobile-wrap radio-class" id="employmentStatus">
                        <div class="field-choice">
                            <input id="field-choice-Full Time" name="radio_source" onclick="showJobFields(event)" value="2" type="radio" />
                            <label for="field-choice-Full Time" class="form-control transition">Full Time</label>
                        </div>
                        <div class="field-choice">
                            <input id="field-choice-Part Time" name="radio_source" onclick="showJobFields(event)" value="3" type="radio" />
                            <label for="field-choice-Part Time" class="form-control transition">Part Time</label>
                        </div>
                        <div class="field-choice">
                            <input id="field-choice-Self Employed" name="radio_source" onclick="showJobFields(event)" value="1" type="radio" />
                            <label for="field-choice-Self Employed" class="form-control transition">Self Employed</label>
                        </div>
                        <div class="field-choice">
                            <input id="field-choice-Pension" name="radio_source" onclick="hideJobFields(event)" value="5" type="radio" />
                            <label for="field-choice-Pension" class="form-control transition">Pension</label>
                        </div>
                        <div class="field-choice">
                            <input id="field-choice-Disability Benefits" name="radio_source" onclick="hideJobFields(event)" value="5" type="radio" />
                            <label for="field-choice-Disability Benefits" class="form-control transition">Disability Benefits</label>
                        </div>
                        <div class="field-choice">
                            <input id="field-choice-Unemployed Benefits" name="radio_source" onclick="hideJobFields(event)" value="6" type="radio" />
                            <label for="field-choice-Unemployed Benefits" class="form-control transition">Unemployed Benefits</label>
                        </div>
                ...
                <div id="job_fields" class="hide_element">
                    <div class="form-group">
                        ...
                        <input onkeyup="toCapitalize(event)" id="jobtitle" type="text" name="Job_title" class="form-control" autocomplete="organization-title" />
                        <div class="messages"></div>
                    </div>
                    <div class="form-group">
                        <label>What is your employer's name?</label>
                        <input onkeyup="toCapitalize(event)" id="employername" type="text" name="Employer_name" class="form-control" autocomplete="organization" />
                        <div class="messages"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-choice mobile-wrap time radio-class">
                            <div class="field-choice">
                                <input onclick="showEmployerMonths(event)" id="noyears" type="radio" name="radio_employerYears" value=">1">
                                <label class="form-control transition" for="noyears">Up to 1 Year</label>
                            </div>
                            <div class="field-choice ">
                                <input onclick="hideEmployerMonths(event)" id="oneyear" type="radio" name="radio_employerYears" value="1-2">
                                <label class="form-control transition" for="oneyear">1 - 2 Years</label>
                            </div>
                            <div class="field-choice ">
                                <input onclick="hideEmployerMonths(event)" id="twoyears" type="radio" name="radio_employerYears" value="2-3">
                                <label class="form-control transition" for="twoyears">2 - 3 Years</label>
                            </div>
                            <div class="field-choice ">
                                <input onclick="hideEmployerMonths(event)" id="threeyears" type="radio" name="radio_employerYears" value="3-4">
                                <label class="form-control transition" for="threeyears">3 - 4 Years</label>
                            </div>
                            <div class="field-choice ">
                                <input onclick="hideEmployerMonths(event)" id="fouryears" type="radio" name="radio_employerYears" value="4-5">
                                <label class="form-control transition" for="fouryears">4 - 5 Years</label>
                            </div>
                            <div class="field-choice ">
                                <input onclick="hideEmployerMonths(event)" id="fiveyears" type="radio" name="radio_employerYears" value="5+">
                ...
                <div class="form-group">
                    ...
                    <div class="form-choice mobile-wrap radio-class">
                        <div class="field-choice">
                            <input id="field-choice-Direct Deposit" name="radio_payment" value="4" type="radio" />
                            <label for="field-choice-Direct Deposit" class="form-control transition">Direct Deposit</label>
                        </div>
                        <div class="field-choice">
                ...
                <div class="form-group">
                    ...
                    <div class="form-choice mobile-wrap radio-class">
                        ...
                        <div class="field-choice">
                            ...
                            <label for="field-choice-Bi-Weekly" class="form-control transition">Bi-Weekly</label>
                        </div>
                        <div class="field-choice">
                            <input id="field-choice-Fortnightly" name="radio_frequency" value="7" type="radio" />
                            <label for="field-choice-Fortnightly" class="form-control transition">Twice Monthly</label>
                        </div>
                        <div class="field-choice">
                ...
                <div class="form-group">
                    ...
                    <input placeholder="Minimum $800" id="netamount" type="tel" class="form-control" name="Net_monthly_amount" autocomplete="off">
                    <div id="net_gross_monthly_msg" class="helpnote">The total after-tax amount of income or pay earned each month from all sources.</div>
                    <div class="messages"></div>
                </div>
