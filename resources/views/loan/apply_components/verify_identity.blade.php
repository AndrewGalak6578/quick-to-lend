                        ...
                        <div class="form-group">
                            <div class="form-choice radio-class">
                                <div class="field-choice">
                                    ...
                                    <label for="field-choice-checking-yes" class="form-control transition">Driver License</label>
                                </div>
                                <div class="field-choice">
                                    <input onclick="hasChecking(event)" id="field-choice-checking-no"
                                           name="Checking_account" value="No" type="radio"/>
                                    <label for="field-choice-checking-no" class="form-control transition">State ID</label>
                                </div>
                                <div class="field-choice">
                                    <input onclick="hasChecking(event)" id="field-choice-checking-no"
                                           name="Checking_account" value="Yes" type="radio"/>
                                    <label for="field-choice-checking-no" class="form-control transition">Passport</label>
                                </div>
                            </div>
                        </div>
                        <hr>
