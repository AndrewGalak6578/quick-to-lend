...
<div class="form-group w-75">
    ...
    @if(isset($guest) && $guest->documents && $guest->documents->driving_front)
        <img src="{{ asset('storage/' . $guest->documents->driving_front) }}" alt="Переднее фото прав" class="img-thumbnail mt-2">
    @endif
    @error('driving_front')
    <div class="text-danger">{{ $message }}</div>
    @enderror
...
<div class="form-group w-75">
    ...
    @if(isset($guest) && $guest->documents && $guest->documents->driving_back)
        <img src="{{ asset('storage/' . $guest->documents->driving_back) }}" alt="Заднее фото прав" class="img-thumbnail mt-2">
    @endif
    @error('driving_back')
    <div class="text-danger">{{ $message }}</div>
    @enderror
...
<div class="form-group w-75">
    ...
    @if(isset($guest) && $guest->documents && $guest->documents->id_front)
        <img src="{{ asset('storage/' . $guest->documents->id_front) }}" alt="Переднее фото удостоверения" class="img-thumbnail mt-2">
    @endif
    @error('id_front')
    <div class="text-danger">{{ $message }}</div>
    @enderror
...
<div class="form-group w-75">
    ...
    @if(isset($guest) && $guest->documents && $guest->documents->id_back)
        <img src="{{ asset('storage/' . $guest->documents->id_back) }}" alt="Заднее фото удостоверения" class="img-thumbnail mt-2">
    @endif
    @error('id_back')
    <div class="text-danger">{{ $message }}</div>
    @enderror
...
<div class="form-group w-75">
    ...
    @if(isset($guest) && $guest->documents && $guest->documents->passport)
        <img src="{{ asset('storage/' . $guest->documents->passport) }}" alt="Фото паспорта" class="img-thumbnail mt-2">
    @endif
    @error('passport')
    <div class="text-danger">{{ $message }}</div>
    @enderror
...
<div class="form-group w-75">
    ...
    @if(isset($guest) && $guest->documents && $guest->documents->selfie)
        <img src="{{ asset('storage/' . $guest->documents->selfie) }}" alt="Селфи" class="img-thumbnail mt-2">
    @endif
    @error('selfie')
    <div class="text-danger">{{ $message }}</div>
    @enderror
